<?php
//Database Connection
		$db = mysqli_connect('localhost','root','','test') or die('Error: can not connect to the database');
	...
	if(isset($_POST['submit'])){
		...
		if(password_verify($password, $row['password'])){
			...
			$profile = "<a class='text-white' href='profile.php?email=$email_msg'>Profile</a>";
		}
		else{
		...
		<div class="row py-5 px-5">
			<div class="col-9">
				<form action="" method="post">
					...
					<div class="row">
						<div class="col-lg-5 bg-white py-4">
							<nav>
						...
						<div class="col-lg-5 bg-white py-4 collapse" id="forget-password">
							<form action="" method="post">
								<input type="email" name="email" placeholder="Enter your email" class="form-control" required>
